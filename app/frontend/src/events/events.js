...
export default class Events {
    ...
    static onTrainingStarted (callback) {
        document.addEventListener(events.trainingStarted, (event) => {
            return callback(event.detail)
        })
    }
    static dispatchTrainingStarted (data) {
        const event = new CustomEvent(events.trainingStarted, {
            detail: data
        })
